...
* https://cxf-rest-workshop.apps.na1.openshift.opentlc.com/rest/query/account/products
* https://cxf-rest-workshop.apps.na1.openshift.opentlc.com/rest/query/marketData/stockPrices
* https://cxf-rest-workshop.apps.na1.openshift.opentlc.com/rest/query/stocks


`https://cxf-rest-workshop.apps.na1.openshift.opentlc.com/rest/swagger.json` will return a Swagger JSON description of services.
